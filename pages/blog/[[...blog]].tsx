    ...
    return(
        ...
        <Head>
          ...
          <link rel="icon" href="/favicon.ico" />
            ...
            <a href="https://dev21.hashnode.dev/error-malformed-postcss-configuration-nextjs" className="card">
            ...
            <a href="https://dev21.hashnode.dev/react-boilerplate-generation" className="card">
              <h2>React Boilerplate Generation &rarr;</h2>
              <p>Boilerplate generation through the ES7 extension (dsznajder).</p>
            </a>
  
            <a href="https://dev21.hashnode.dev/hoisting-in-javascript" className="card">
